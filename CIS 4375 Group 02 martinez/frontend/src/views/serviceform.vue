...
import { createService, getServiceById, updateService, deleteService } from '../api/api'
...
export default {
    setup() {
        ...
        // Fetch service details if editing an existing service
        onMounted(async () => {
            ...
            if (serviceId) {
                ...
                try {
                    ...
                    toast.error('Error retrieving service details:', error);
                }
            }
        });
        ...
        const handleSubmitForm = async () => {
            ...
            try {
                if (isEditing.value) {
                    await updateService(service.value.id, service.value);
                ...
                toast.error('Error saving service:', error);
            }
        };
        ...
        return { v$, service, validations, isEditing, handleSubmitForm, handleDeleteService };
    }
};
</script>
